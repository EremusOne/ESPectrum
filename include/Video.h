...
#define TS_SCREEN_PENTAGON     17987  // START OF ULA DRAW PAPER PENTAGON

#define TS_BORDER_320x240 2236  // START OF BORDER 48 -> (8943 + 1) >> 2
#define TS_BORDER_320x240_128 2218  // START OF BORDER 128 -> (8873 + 1) >> 2
#define TS_BORDER_320x240_PENTAGON 12595  // START OF BORDER PENTAGON

#define TS_BORDER_360x200 3356  // START OF BORDER 48 -> (13423 + 1) >> 2
#define TS_BORDER_360x200_128 3358  // START OF BORDER 128 -> (13433 + 1) >> 2
