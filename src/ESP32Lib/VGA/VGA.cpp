...
const Mode VGA::MODE320x240(38, 32, 58, 320, 28, 3, 40, 240, 1, 7000000, 1, 1);  // 15625 / 50.08
const Mode VGA::MODE360x200(12, 32, 44, 360,  8, 3, 31, 270, 1, 7000000, 1, 1);  // 15625 / 50.08
#endif
